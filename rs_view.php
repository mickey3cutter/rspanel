...
body.login h1 a{
	...
	<?php } else { ?> background: url(<?php echo plugin_dir_url( __FILE__ ) ?>img/redstone.png) no-repeat !important;<?php } ?>
	width: 100% !important;
...
body.wp-core-ui .button-primary{
	...
	background: <?php if($color) { echo $color; }  else { echo '#aa1900;'; } ?>;
	text-shadow: none;
	padding: 0px 25px;
	height: 45px;
	line-height: 45px;
...
/*#adminmenu .wp-submenu a:focus, #adminmenu .wp-submenu a:hover, #adminmenu a:hover, #adminmenu li.menu-top>a:focus,#adminmenu li:hover div.wp-menu-image:before,#collapse-menu:hover, #collapse-menu:hover #collapse-button div:after, #adminmenu li.menu-top:hover, #adminmenu li.opensub>a.menu-top, #adminmenu li>a.menu-top:focus, #adminmenu li a:focus div.wp-menu-image:before, #adminmenu li.opensub div.wp-menu-image:before, #adminmenu li:hover div.wp-menu-image:before{
...
#adminmenu{
	padding-top: 60px; 
	<?php if($option['logo']) { ?>background: url(<?php echo $option['logo']; ?>) 10px 12px no-repeat; <?php } ?>
}
#footer-thankyou{
	font-style: normal;
}
...
.folded .wp-first-item.menu-top-first{
	<?php if($option['logo']) { ?>background: url(<?php echo $option['logo']; ?>) 10px 50% no-repeat; <?php } ?>
